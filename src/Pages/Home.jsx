...
function Home() {
    ...
    useEffect(() => {
        const fetchNews = async () => {
            try {
                ...
                console.error("Haberler yüklenirken köprüde hata oluştu:", error);
                setLoading(false);
            }
        };
        fetchNews();
    ...
    // 1. Veri yükleme simülasyonu ve Kategori Kaydırma Efekti
    useEffect(() => {
        setTimeout(() => setLoading(false), 800);
                ...
                {featuredNews && !loading && (
                    <section className="featured-section">
                        ...
                        <div
                            ...
                            onClick={() => navigate(`/haber/${featuredNews.id}`)} // Tıklayınca detay sayfasına gider
                            style={{ cursor: 'pointer' }} // El imleci çıksın ki tıklandığı anlaşılsın
                        >
