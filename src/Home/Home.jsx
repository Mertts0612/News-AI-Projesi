...
import MatchStatsWidget from "../MatchStatsWidget/MatchStatsWidget";
import EarthquakePanel from "../EarthquakePanel/EarthquakePanel";
        ...
        <div className="home-page" data-theme={theme}>
            ...
            <main className="container" style={{ marginTop: '2rem' }}>
                <section className="hero">
                    {/* Öne Çıkan Haber - başlığın hemen altında; loading sırasında da yer kaplar (layout kayması önlenir) */}
                    {activeCategory === "Tümü" && (
                            ...
                            {loading ? (
                                <div className="featured-card featured-card-skeleton" aria-hidden>
                                    ...
                                    <div className="featured-content">
                                        <div className="featured-meta"><span className="category-tag">...</span><span className="date">...</span></div>
                                        <div className="featured-skeleton-title" />
                                        <div className="featured-skeleton-text" />
                                    </div>
                                </div>
                            ) : featuredNews ? (
                            <div
